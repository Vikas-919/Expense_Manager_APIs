...
public class UserServiceImpl implements UserService{
    ...
    public void updateRole(User user, Role role) {
        ...
        switch (role.getRole()){
            ...
            case "Developer":{
                user.setRoles(Arrays.asList(roleRepository.findByRole("ROLE_USER"),roleRepository.findByRole("ROLE_DEVELOPER")));
                break;
            }
            case "Admin":{
                user.setRoles(Arrays.asList(roleRepository.findByRole("ROLE_USER"),roleRepository.findByRole("ROLE_DEVELOPER"),roleRepository.findByRole("ROLE_ADMIN")));
                break;
            }
        }
    }
